...
class PointTransformerCls(nn.Module):
    def __init__(self,num_rc,num_class,d_points, transformer_dim, num_neigh, model_size='large', radius=0.2, classify=False, split='early', lratio_known=False, boundary_known=False, lprotocol_known=False, dimension_known=False, normal_channel=True):
